...
function M.open_time_blocker()
  ...
  -- Set key mappings
  vim.api.nvim_buf_set_keymap(buf, 'n', '+', ':lua require("time_blocker").add_new_block()<CR>', { noremap = true, silent = true })
  vim.api.nvim_buf_set_keymap(buf, 'n', '-', ':lua require("time_blocker").remove_block()<CR>', { noremap = true, silent = true })
  vim.api.nvim_buf_set_keymap(buf, 'n', '.', ':lua require("time_blocker").repeat_block()<CR>', { noremap = true, silent = true })
  vim.api.nvim_buf_set_keymap(buf, 'n', 'c', ':lua require("time_blocker").copy_block()<CR>', { noremap = true, silent = true })
  vim.api.nvim_buf_set_keymap(buf, 'n', 'x', ':lua require("time_blocker").cut_block()<CR>', { noremap = true, silent = true })
  vim.api.nvim_buf_set_keymap(buf, 'n', 'v', ':lua require("time_blocker").paste()<CR>', { noremap = true, silent = true })
  vim.api.nvim_buf_set_keymap(buf, 'n', 'r', ':lua require("time_blocker").reset()<CR>', { noremap = true, silent = true })
